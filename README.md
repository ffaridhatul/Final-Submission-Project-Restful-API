...
```
cd existing_repo
git remote add origin https://git.enigmacamp.com/enigma-20/faridhatul-zikri/challenge-restful-api-java.git
git branch -M master
...
- [ ] [Set up project integrations](https://git.enigmacamp.com/enigma-20/faridhatul-zikri/challenge-restful-api-java/-/settings/integrations)
